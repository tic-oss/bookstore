...
module.exports = class extends Generator {
  ...
  writing() {
    ...
    this.fs.copyTpl(
      this.templatePath("backend/src/model/notes.js"),
      this.destinationPath("backend/src/model/notes.js")
    );
    this.fs.copyTpl(
      this.templatePath("backend/src/routes/note.routes.js"),
      this.destinationPath("backend/src/routes/note.routes.js")
    );
